    ...
    return jsonSuccess(
      {
        ...
        operationalHealthScore: insights.operationalHealthScore,
        operationalHealthBreakdown: insights.operationalHealthBreakdown,
      },
      'AI Executive summary fetched successfully'
    );
  });
}
